...
import { telanganaSites } from './data/telanganaSites';
import { keralaSites } from './data/keralaSites';
import { tamilNaduSites } from './data/tamilNaduSites';
import { karnatakaSites } from './data/karnatakaSites';
import { andamanSites } from './data/andamanSites';
import { puducherrySites } from './data/puducherrySites';
            ...
            {filteredSites.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-xl text-gray-600">
                  {['west-bengal', 'telangana', 'kerala', 'tamil-nadu', 'karnataka', 'andaman-nicobar', 'puducherry'].includes(selectedState)
